...
public class Member implements UserDetails {
    ...
    @Builder
    public Member(Long id, String phone, String pw, String name, String nickname, String birth, LocalDate regDate, LocalDate delDate, MemberRole role, List<Report> reports, Authority authority, String profileImgPath, List<MemberChatRoom> memberChatRoom, Blacklist blacklist, AdminTeam adminTeam) {
        this.id = id;
        this.phone = phone;
        this.pw = pw;
        this.name = name;
